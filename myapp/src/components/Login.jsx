            ...
            <form className="form_container" onSubmit={handleSubmit}>
                <div className="logo_container"></div>
                    <div className="title_container">
                        ...
                        <span className="subtitle">Log into to gain full access.</span>
                    </div>
                    <br></br>
                    <div className="input_container">
                        ...
                        <input placeholder="name@mail.com" title="Input title" name="input-name" type="text" className="input_field" id="email_field" onChange={(e) => setEmail(e.target.value)} />
                    </div>
                    <div className="input_container">
                        ...
                        <input placeholder="Password" title="Input title" name="input-name" type="password" className="input_field" id="password_field" onChange={(e) => setPassword(e.target.value)}/>
                    </div>
                    ...
                    <button title="Sign In" type="submit" className="sign-up" onClick={handleClick}>
                    ...
                    <a href="/terms" className="note">Terms of use &amp; Conditions</a>
            </form>
        </div>
        <Footer />
        </>
