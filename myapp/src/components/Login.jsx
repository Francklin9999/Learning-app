        ...
        <div className="login-main-content">
            <form className="login-form_container" onSubmit={handleSubmit}>
                    ...
                    <div className="login-input_container">
                        ...
                        <input placeholder="name@mail.com" title="Input title" name="input-name" type="text" className="login-input_field" id="login-email_field" onChange={(e) => setEmail(e.target.value)} />
                    </div>
                    <div className="login-input_container">
