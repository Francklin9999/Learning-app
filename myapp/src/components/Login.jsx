        ...
        <div className="login-main-content">
            <form className="login-form_container" onSubmit={handleSubmit}>
                    ...
                    <div className="login-input_container">
                        ...
                        <svg fill="none" viewBox="0 0 24 24" height="24" width="24" xmlns="http://www.w3.org/2000/svg" className="login-icon">
                        ...
                        <input placeholder="name@mail.com" title="Input title" name="input-name" type="text" autocomplete="email" className="login-input_field" id="login-email_field" onChange={(e) => setEmail(e.target.value)} />
                    </div>
                    <div className="login-input_container">
                        <label className="login-input_label" for="password_field">Password</label>
                        <svg fill="none" viewBox="0 0 24 24" height="24" width="24" xmlns="http://www.w3.org/2000/svg" className="login-icon">
                        ...
                        <input placeholder="Password" title="Input title" name="input-name" type="password" autocomplete="current-password" className="login-input_field" id="password_field" onChange={(e) => setPassword(e.target.value)}/>
                    </div>
